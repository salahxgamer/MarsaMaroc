...
SECRET_KEY = "django-insecure-2adccgg6vhr!*s$j8&*zdws(1d7!%=gdkq7-(mx^8+gy=fa2y$"
...
INSTALLED_APPS = [
    # django-admin-interface admin site styling
    'admin_interface',
    'colorfield',
...
# Required for django-admin-interface popups
